...
public class UserDaoImpl implements UserDao {
  ...
  public void register(User user) {
    ...
    {
    	String SQL = "update users set no_of_attempts = ? where username = ?";
        jdbcTemplate.update(SQL, user.getNo_of_attempts(), user.getUsername());
    }
  }
  ...
  public User mapRow(ResultSet rs, int arg1) throws SQLException {
    ...
    user.setNo_of_attempts(rs.getInt("no_of_attempts"));
    return user;
  }
}